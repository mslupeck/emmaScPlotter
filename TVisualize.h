...
private:
	...
	void SetViewportSize(double x0, double y0, double z0, double x1, double y1, double z1);
	...
	void DrawScSetup(TScMapReader* scMap);
...
public:
	...
	void Visualize(TScMapReader* scMap);
};
